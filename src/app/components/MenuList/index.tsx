  ...
  return (
    <ul>
      ...
      <MenuItem
        ...
        className={clsx(
          actualSection === SectionEnum.Showcase && "bg-white text-black"
        )}
      >
        Showcase
      </MenuItem>
      <MenuItem
        ...
        className={clsx(
          actualSection === SectionEnum.Services && "bg-white text-black"
        )}
      >
        Services
      </MenuItem>
      <MenuItem
        ...
        className={clsx(
          actualSection === SectionEnum.Designers && "bg-white text-black"
        )}
      >
        Designers
      </MenuItem>
      <MenuItem
        ...
        className={clsx(
          actualSection === SectionEnum.Packages && "bg-white text-black"
        )}
      >
        Packages
      </MenuItem>
      <MenuItem
        ...
        className={clsx(
          actualSection === SectionEnum.Contact && "bg-white text-black"
        )}
      >
        Contact
      </MenuItem>
